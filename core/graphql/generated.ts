...
export type LessonBySlugQuery = { __typename?: 'Query', lesson?: { __typename?: 'Lesson', title: string, videoId: string, description?: string | null, teacher?: { __typename?: 'Teacher', name: string, bio: string, avatarURL: string } | null } | null };

export type LessonsQueryVariables = Exact<{ [key: string]: never; }>;


export type LessonsQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', id: string, lessonType: LessonType, availableAt?: any | null, title: string, slug: string }> };
...
/**
 * __useLessonBySlugQuery__
 *
 * To run a query within a React component, call `useLessonBySlugQuery` and pass it any options that fit your needs.
 * When your component renders, `useLessonBySlugQuery` returns an object from Apollo Client that contains loading, error, and data properties
 ...
 * });
 */
export function useLessonBySlugQuery(baseOptions: Apollo.QueryHookOptions<LessonBySlugQuery, LessonBySlugQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<LessonBySlugQuery, LessonBySlugQueryVariables>(LessonBySlugDocument, options);
      }
export function useLessonBySlugLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<LessonBySlugQuery, LessonBySlugQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<LessonBySlugQuery, LessonBySlugQueryVariables>(LessonBySlugDocument, options);
        }
export type LessonBySlugQueryHookResult = ReturnType<typeof useLessonBySlugQuery>;
export type LessonBySlugLazyQueryHookResult = ReturnType<typeof useLessonBySlugLazyQuery>;
export type LessonBySlugQueryResult = Apollo.QueryResult<LessonBySlugQuery, LessonBySlugQueryVariables>;
